...
class OpenMeteoService extends BaseService
{
    ...
    /**
     * Get storm risk for location with timeout handling
     */
    public function getStormRisk($latitude, $longitude)
    {
        try {
            ...
            Log::warning("Weather API timeout for {$latitude}, {$longitude}: " . $e->getMessage());
            return ['risk' => 'unknown', 'score' => 0, 'message' => 'Weather API timeout'];
        }
    }
